...
RESOURCES += src/qt/fline.qrc src/qt/fline_locale.qrc

TRANSLATIONS += src/qt/locale/fline_bg.ts \
                src/qt/locale/fline_de.ts \
                src/qt/locale/fline_en.ts \
                src/qt/locale/fline_es.ts \
                src/qt/locale/fline_fi.ts \
                src/qt/locale/fline_fr.ts \
                src/qt/locale/fline_it.ts \
                src/qt/locale/fline_ja.ts \
                src/qt/locale/fline_pl.ts \
                src/qt/locale/fline_pt.ts \
                src/qt/locale/fline_ru.ts \
                src/qt/locale/fline_sk.ts \
                src/qt/locale/fline_sv.ts \
                src/qt/locale/fline_vi.ts \
                src/qt/locale/fline_zh_CN.ts \
                src/qt/locale/fline_zh_TW.ts
