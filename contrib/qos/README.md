...
This means one can have an always-on flined instance running, and another local flined/fline-qt instance which connects to this node and receives blocks from it.
