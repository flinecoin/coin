/* src/config/fline-config.h.  Generated from fline-config.h.in by configure.  */
/* src/config/fline-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef FLINE_CONFIG_H

#define FLINE_CONFIG_H
...
#define PACKAGE_NAME "Fline Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Fline Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "fline"
