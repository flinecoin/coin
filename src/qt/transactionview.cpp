                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Fline from zFline"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zFline"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zFline));
