                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Fline Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Fline address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and fline: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFLINE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Fline Core"), this);
    aboutAction->setStatusTip(tr("Show information about Fline Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Fline"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Fline addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Fline addresses"));
    ...
    openAction->setStatusTip(tr("Open a Fline: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Fline Core help message to get a list with possible Fline command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Fline Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Fline network", "", count));
}
...
{
    QString strTitle = tr("Fline Core"); // default title
