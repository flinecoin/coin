...
/** Utility functions used by the Fline Qt UI.
 */
namespace GUIUtil
{
...
// Render Fline addresses in monospace font
...
// Parse "fline:" URI into recipient object, return true on successful parsing
