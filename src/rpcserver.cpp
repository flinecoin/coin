...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Fline features */
        {"fline", "masternode", &masternode, true, true, false},
        {"fline", "listmasternodes", &listmasternodes, true, true, false},
        {"fline", "getmasternodecount", &getmasternodecount, true, true, false},
        {"fline", "masternodeconnect", &masternodeconnect, true, true, false},
        {"fline", "masternodecurrent", &masternodecurrent, true, true, false},
        {"fline", "masternodedebug", &masternodedebug, true, true, false},
        {"fline", "startmasternode", &startmasternode, true, true, false},
        {"fline", "createmasternodekey", &createmasternodekey, true, true, false},
        {"fline", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"fline", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"fline", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"fline", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"fline", "getmasternodescores", &getmasternodescores, true, true, false},
        {"fline", "mnbudget", &mnbudget, true, true, false},
        {"fline", "preparebudget", &preparebudget, true, true, false},
        {"fline", "submitbudget", &submitbudget, true, true, false},
        {"fline", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"fline", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"fline", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"fline", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"fline", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"fline", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"fline", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"fline", "checkbudgets", &checkbudgets, true, true, false},
        {"fline", "mnsync", &mnsync, true, true, false},
        {"fline", "spork", &spork, true, true, false},
        {"fline", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"fline", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use flined, or the -server option to fline-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> fline-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15235/\n";
}
