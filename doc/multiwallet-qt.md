...
In order to support loading of multiple wallets in fline-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is fline.cpp.
...
Changes to fline.cpp
----------------------
fline.cpp is the entry point into fline-qt, and as such, will require some minor modifications to provide hooks for
